...
Trong summary dữ liệu cũ vẫn có số 45.259 documents. Đây là summary của một giai đoạn build cũ hoặc bản corpus trước khi mở rộng. Báo cáo này sử dụng con số 82.677 cho bản final, đồng thời ghi rõ sự khác biệt nếu cần đối chiếu.
\begin{table}[H]
\centering
